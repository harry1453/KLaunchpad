...
infix operator fun ByteArray.plus(other: ByteArray): ByteArray {
...
infix operator fun ByteArray.plus(other: Int): ByteArray {
...
infix operator fun ByteArray.plus(other: Byte): ByteArray {
    val newArray = ByteArray(this.size + 1)
    this.copyInto(newArray)
