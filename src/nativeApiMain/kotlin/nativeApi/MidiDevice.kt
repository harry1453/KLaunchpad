...
public fun getInputDeviceInfoName(infoPtr: COpaquePointer): CPointer<ByteVar> = externalFunction {
...
public fun getInputDeviceInfoVersion(infoPtr: COpaquePointer): CPointer<ByteVar> = externalFunction {
    val midiInputDeviceInfo = infoPtr.toObject<MidiInputDeviceInfo>()
    return midiInputDeviceInfo.version.cstr.getPointer(GlobalMemScope)
}

@CName("KLaunchpad_midiOutputDeviceInfo_getName")
public fun getOutputDeviceInfoName(infoPtr: COpaquePointer): CPointer<ByteVar> = externalFunction {
...
public fun getOutputDeviceInfoVersion(infoPtr: COpaquePointer): CPointer<ByteVar> = externalFunction {
    val midiOutputDeviceInfo = infoPtr.toObject<MidiOutputDeviceInfo>()
